...
protected:
	...
	void writeToFile(std::string str) const;
	...
	virtual void compareEntries(std::list<fs::path> leftEntries, std::list<fs::path> rightEntries) const = 0;
public:
...
private:
	...
	virtual void compareEntries(std::list<fs::path> leftEntries, std::list<fs::path> rightEntries) const;
public:
